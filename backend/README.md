...
> Note: The project now has a decoupled frontend in `../frontend` and a root-level Docker workflow via `../env.sh`. This backend README focuses on backend-only workflow.
