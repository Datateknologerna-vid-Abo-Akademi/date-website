...
urlpatterns = [
    ...
    path("auth/activate/<str:uidb64>/<str:token>", views.ActivateApiView.as_view(), name="auth-activate"),
    path("auth/password-reset", views.PasswordResetRequestApiView.as_view(), name="auth-password-reset"),
    path(
        "auth/password-reset/<str:uidb64>/<str:token>",
        views.PasswordResetConfirmApiView.as_view(),
        name="auth-password-reset-confirm",
    ),
    path("auth/password-change", views.PasswordChangeApiView.as_view(), name="auth-password-change"),
    ...
    path("news/feed", views.NewsFeedApiView.as_view(), name="news-feed"),
    ...
    path("events/feed", views.EventsFeedApiView.as_view(), name="events-feed"),
    ...
    path(
        "archive/pictures/id/<int:collection_id>",
        views.ArchivePictureCollectionByIdApiView.as_view(),
        name="archive-pictures-by-id",
    ),
    path(
