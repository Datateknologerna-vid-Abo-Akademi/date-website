    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ctf",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="ctf.ctf", verbose_name="CTF"),
                ),
                (
                    "flag",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="ctf.flag", verbose_name="Flagga"
                    ),
                ),
                (
                    "user",
