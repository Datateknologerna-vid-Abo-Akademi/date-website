    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(
                blank=True, default=django.utils.timezone.now, null=True, verbose_name="Avanmälningen stängs"
            ),
        ),
        migrations.AlterField(
            model_name="event",
            ...
            field=models.DateTimeField(
                blank=True, default=django.utils.timezone.now, null=True, verbose_name="Anmälningen stängs"
            ),
        ),
        migrations.AlterField(
            model_name="event",
