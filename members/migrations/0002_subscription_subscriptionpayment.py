    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "renewal_scale",
                    models.CharField(
                        choices=[("day", "Dagar"), ("month", "Månader"), ("year", "År")],
                        max_length=10,
                        null=True,
                        verbose_name="Förnyelse skala",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date_expires",
                    models.DateField(blank=True, default=django.utils.timezone.now, null=True, verbose_name="Betald"),
                ),
                (
                    "amount_paid",
                    models.DecimalField(
                        blank=True, decimal_places=2, max_digits=9, null=True, verbose_name="Betald summa"
                    ),
                ),
                ("member", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                (
                    "subscription",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="members.Subscription"),
                ),
            ],
            options={
