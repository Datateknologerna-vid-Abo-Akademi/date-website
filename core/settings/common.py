...
if USE_S3:
    ...
    AWS_S3_PUBLIC_CUSTOM_DOMAIN = env_alias('S3_PUBLIC_CUSTOM_DOMAIN', 'AWS_S3_PUBLIC_CUSTOM_DOMAIN', default='') or None
    AWS_S3_PRIVATE_CUSTOM_DOMAIN = env_alias('S3_PRIVATE_CUSTOM_DOMAIN', 'AWS_S3_PRIVATE_CUSTOM_DOMAIN', default='') or None
